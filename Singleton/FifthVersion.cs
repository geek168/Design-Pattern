...
namespace Singleton
{
     ...
     * but has all the performance benefits of the previous ones. 
     * Note that although nested classes have access to the enclosing class's private members, 
     ...
     */
    public sealed class FifthVersion
    {
        private FifthVersion()
        {
        }

        public static FifthVersion GetInstance()
        {
        ...
        private class Nested
        {
            ...
            internal static readonly FifthVersion Instance = new FifthVersion();
        }
    }
}
